...
FACTORY_LINE: tuple[FactoryStage, ...] = (
    ...
    FactoryStage(11, "clip_research", "Clip Research", "assets", "partial", PipelineStep.CLIP_RESEARCH),
    FactoryStage(12, "asset_collector", "Asset Collector", "assets", "partial", PipelineStep.ASSET_COLLECTOR),
    FactoryStage(13, "asset_manager", "Asset Manager", "assets", "ready", PipelineStep.ASSET_INDEX),
    FactoryStage(
        14,
        "media_analyze",
        "Media Analyze",
    ...
    FactoryStage(16, "takes", "Takes Manager", "assets", "ready", PipelineStep.TAKES),
    FactoryStage(17, "voice", "Voice Agent", "production", "ready", PipelineStep.VOICE),
    FactoryStage(18, "subtitle", "Subtitle Agent", "production", "ready", PipelineStep.SUBTITLE),
    FactoryStage(19, "editor", "Editor AI", "production", "ready", PipelineStep.EDITOR),
    FactoryStage(20, "thumbnail", "Thumbnail AI", "production", "partial", PipelineStep.THUMBNAIL),
    FactoryStage(21, "quality", "Quality AI", "quality", "ready", PipelineStep.QUALITY),
    FactoryStage(
        22,
        "retention",
        "Retention Engine",
    ...
    FactoryStage(23, "video_review", "Video Reviewer", "quality", "ready", PipelineStep.VIDEO_REVIEW),
    FactoryStage(
        24,
        "auto_retry",
        "Auto Retry",
    ...
    FactoryStage(27, "viral_intelligence", "Viral Intelligence", "intelligence", "ready", PipelineStep.CONTENT_INTELLIGENCE),
    FactoryStage(28, "learning", "Learning Engine", "intelligence", "ready", PipelineStep.LEARNING),
    FactoryStage(
        29,
        "knowledge_base",
        "Knowledge Base",
    ...
    FactoryStage(31, "analytics", "Analytics", "intelligence", "ready", PipelineStep.ANALYTICS),
    FactoryStage(32, "seo", "SEO Engine", "publishing", "ready", PipelineStep.SEO),
    FactoryStage(33, "publisher", "Publisher", "publishing", "partial", PipelineStep.PUBLISHER),
    FactoryStage(34, "dashboard", "Dashboard", "dashboard", "ready", implementation="apps/dashboard"),
)
